...
- **COG-010**: No non-comment oracle literals detected in `src/breeds/production_rules.rs`.
  Formal scan test at `tests/cog010_oracle_scan.rs` covers this breed; receipt written to
