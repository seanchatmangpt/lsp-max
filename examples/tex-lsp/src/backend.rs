...
#[lsp_max::async_trait]
impl lsp_max::LanguageServer for TexBackend {
    async fn initialize(
        &self,
    ...
    async fn did_open(&self, params: lsp_max::lsp_types_max::DidOpenTextDocumentParams) {
        ...
        self.lsp_max_ast
            .handle_did_open(params, tree_sitter_latex::LANGUAGE.into());
    ...
    async fn did_change(&self, params: lsp_max::lsp_types_max::DidChangeTextDocumentParams) {
        ...
        let version = params.text_document.version;
        self.lsp_max_ast
            .handle_did_change(params, tree_sitter_latex::LANGUAGE.into());
