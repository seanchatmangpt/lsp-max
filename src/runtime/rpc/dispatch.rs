use crate::runtime::mesh::{build_conformance_vector, AutonomicMesh};
use crate::runtime::mesh_types::{InstanceId, MaxMethod, MeshAction};
use crate::runtime::sha256::sha256;
use crate::runtime::typestate::DeterministicSnapshot;
    ...
    pub fn dispatch_rpc(
        ...
        match max_method {
            ...
            MaxMethod::RestoreState => {
                let state: crate::runtime::mesh_types::AutonomicMeshState =
                    serde_json::from_value(params).map_err(|e| format!("Invalid params: {}", e))?;
            ...
            MaxMethod::ConformanceDelta => {
                let since_seq: u64 = params
                    ...
                    .and_then(|v| v.as_u64())
                    .unwrap_or(0);
                let deltas: Vec<&crate::runtime::mesh_types::ConformanceDeltaEntry> = self
