use crate::runtime::mesh_hooks::{IntakeClearHook, IntakeDiagnosticHook, OcelProcessHook};
...
impl AutonomicMesh {
    ...
    pub fn hook_descriptors(&self) -> Vec<crate::runtime::mesh_types::HookDescriptor> {
