use crate::andon::{AdmissionGate, AdmissionStatus, AndonBus, AndonEvent};
use crate::core::TruthTable;
use crate::lsp::VirtualDocRegistry;
...
impl LspMaxHarness {
    ...
    pub fn push_event(&mut self, event: AndonEvent) {
        ...
        let diag = crate::lsp::LspPushAdapter::event_to_diagnostic(&event);
    ...
    pub fn assert_no_vacuous_green(&self) {
        for row in &self.truth_table.rows {
            if row.verdict == crate::core::ProbeResult::Pass {
