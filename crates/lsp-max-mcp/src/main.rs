use lsp_max_compositor_routing::{
    CompositorConfig, DispatchStrategy, ExtensionRouter,
    dispatch_strategy, servers_for_uri,
};
...
fn build_router(cfg: &CompositorConfig) -> ExtensionRouter {
    use lsp_max_compositor_routing::{ChildServer, ChildTier};
