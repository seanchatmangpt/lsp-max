...
fn message_inventory_matches_metamodel() {
    ...
    let inv_path = root.join("crates/anti-llm-cheat-lsp/generated/lsp318_message_inventory.json");
    assert!(
        inv_path.exists(),
    ...
    let sg_path = root.join("crates/anti-llm-cheat-lsp/generated/lsp318_spec_graph.json");
    if sg_path.exists() {
