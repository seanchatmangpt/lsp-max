...
impl TelemetryService {
    ...
    pub fn export(
        ...
        let instance_id = lsp_max::max_runtime::InstanceId::from(instance_id_str.clone());
        // Record export as a bounded action
        mesh.execute_action(lsp_max::max_runtime::MeshAction::ExecuteBoundedAction {
        ...
        let hash = lsp_max::max_runtime::sha256(receipt_id.as_bytes());
        mesh.execute_action(lsp_max::max_runtime::MeshAction::EmitReceipt {
            instance_id,
