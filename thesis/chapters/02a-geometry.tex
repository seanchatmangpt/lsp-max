...
\medskip
With four pillars in place---composition (algebra), verdicts (order), transition
(analysis), and law-state (geometry)---the mathematical substrate of the thesis is
assembled. The conceptual framework of \cref{ch:framework} may now be read as
their application, and the artifact of \cref{ch:artifact} as their instantiation.
