...
falsifiable rather than merely evocative. Four pillars are built, each
terminating in a result used later:
...
\input{chapters/02a-algebra}
\input{chapters/02a-order-logic}      % Pillar II
\input{chapters/02a-analysis}         % Pillar III
\input{chapters/02a-geometry}         % Pillar IV
